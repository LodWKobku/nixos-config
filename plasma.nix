{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-d7f26ac8-d829-42d0-909e-61cb9c37da1c = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2026,3,17,18,30,29.856";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      kactivitymanagerdrc.activities.d7f26ac8-d829-42d0-909e-61cb9c37da1c = "Default";
      ...
      kdeglobals.WM.activeBlend = "229,200,144";
      kdeglobals.WM.activeForeground = "198,208,245";
      kdeglobals.WM.inactiveBackground = "48,52,70";
      kdeglobals.WM.inactiveBlend = "115,121,148";
      kdeglobals.WM.inactiveForeground = "198,208,245";
      kscreenlockerrc.Daemon.Autolock = false;
      kscreenlockerrc.Daemon.LockOnResume = false;
      kscreenlockerrc.Daemon.Timeout = 0;
      kwalletrc.Wallet."First Use" = false;
      kwinrc.Desktops.Id_1 = "699f380c-6567-42de-be8c-ca973f08ec32";
      kwinrc.Desktops.Number = 1;
      kwinrc.Desktops.Rows = 1;
      kwinrc."Tiling/699f380c-6567-42de-be8c-ca973f08ec32/6cb3ede7-2a0c-4824-a095-faf5d80d5e2f".padding = 4;
      kwinrc."Tiling/699f380c-6567-42de-be8c-ca973f08ec32/6cb3ede7-2a0c-4824-a095-faf5d80d5e2f".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      plasmaparc.General.GlobalMuteSinksMutedDevices = "alsa_output.pci-0000_00_05.0.analog-stereo.0";
      spectaclerc.ImageSave.translatedScreenshotsFolder = "Screenshots";
      spectaclerc.VideoSave.translatedScreencastsFolder = "Screencasts";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0".URL = "file:///home/user/Documents/nixos-nowe/home.nix";
      "kate/anonymous.katesession"."Document 1".URL = "file:///home/user/Documents/nixos-nowe/flake.nix";
      "kate/anonymous.katesession"."Document 2".URL = "file:///home/user/Documents/nixos-nowe/configuration.nix";
      "kate/anonymous.katesession"."Document 3".URL = "file:///home/user/Documents/nixos-nowe/plasma.nix";
      "kate/anonymous.katesession"."Document 4".URL = "file:///home/user/Documents/nixos-nowe/plasmaOFF.nix";
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-LastSize = 205;
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-SectSizes = 0;
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 943;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 943;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-LastSize = 370;
      ...
      "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,572,370";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 1" = 3;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 2" = 4;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 3" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 4" = 2;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0".CursorColumn = 29;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0".CursorLine = 20;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2".CursorColumn = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2".CursorLine = 113;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2".ScrollLine = 96;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3".CursorColumn = 25;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3".CursorLine = 130;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3".ScrollLine = 105;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4".ScrollLine = 423;
